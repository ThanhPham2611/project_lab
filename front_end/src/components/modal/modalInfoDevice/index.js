  ...
  return (
    ...
    >
      <Spin spinning={loading} tip="Đang tải....">
        <Row>
          <Col span={9} className={[styles.textLabel, styles.textFont]}>
            Tên thiết bị:{" "}
          </Col>
          <Col className={styles.textFont}>
            {dataDevice?.dataInfo?.deviceName}
          </Col>
        </Row>
        <Row>
          <Col span={9} className={[styles.textLabel, styles.textFont]}>
          ...
          <Col className={styles.textFont}>
            {dataDevice?.dataInfo?.deviceCode}
          </Col>
        </Row>
        <Row>
          <Col span={9} className={[styles.textLabel, styles.textFont]}>
          ...
          <Col className={styles.textFont}>
            {moment(dataDevice?.dataInfo?.createdAt).format("DD-MM-YYYY")}
          </Col>
        </Row>
        <Row>
          <Col span={9} className={[styles.textLabel, styles.textFont]}>
          ...
          <Col className={styles.textFont}>
            {detailLocationDevice(
              dataDevice?.dataInfo?.deviceLocation[0],
              dataDevice?.dataInfo?.deviceLocation[1]
            )}
          </Col>
        </Row>
        <Row>
          ...
          <Col className={styles.textFont}>
            {deviceStatus(dataDevice?.dataInfo?.status)}
          </Col>
        </Row>
        {dataDevice.nameUser && (
          <div>
            <Row>
              ...
              >{`${dataDevice.nameUser.firstName} ${dataDevice.nameUser.lastName}`}</Col>
            </Row>
            <Row>
              <Col span={9} className={[styles.textLabel, styles.textFont]}>
                Thời gian mượn:
              ...
              <Col className={styles.textFont}>
                {moment(dataDevice?.dataInfo?.borrowDate).format("DD-MM-YYYY")}
              </Col>
            </Row>
            <Row>
              <Col span={9} className={[styles.textLabel, styles.textFont]}>
              ...
              <Col className={styles.textFont}>
                {moment(dataDevice?.dataInfo?.returnDate).format("DD-MM-YYYY")}
              </Col>
            </Row>
          </div>
        )}
        <Row style={{ marginTop: 20 }} justify="center">
          <Space>
            {dataDevice?.dataInfo?.status === 0 ? (
              <ButtonPrimary
                nameBtn="Cho mượn"
                onClickBtn={() => setModalBorrow(true)}
              />
            ) : (
              <ButtonPrimary
                nameBtn="Thu hồi"
                onClickBtn={handleReturnDevice}
              />
            )}
